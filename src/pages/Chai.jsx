import Chai1 from "../assets/chai1.avif";
import Chai2 from "../assets/chai2.avif";
import Chai3 from "../assets/chai3.avif";
import Chai4 from "../assets/chai4.avif";
const restaurants = [
  {
    id: 1,
    name: "Chai Zyka ",
    rating: "4.5",
    time: "20-25 mins",
    categories: "Chai, Indian, North Indian",
    area: "RAM HALL BIRHANA ROAD",
    offer: "50% OFF",
    image: Chai1,
  },
  {
    id: 2,import Chai1 from "../assets/chai1.avif";
import Chai2 from "../assets/chai2.avif";
import Chai3 from "../assets/chai3.avif";
import Chai4 from "../assets/chai4.avif";
...
const Chai = () => {
  return (
    ...
    <div className="max-w-7xl mx-auto px-6 py-10">
      ...
      <h1 className="text-4xl font-bold mb-2">Chai</h1>
      <p className="text-gray-600 mb-6 font-bold">
        Taste these delectable classics, delectable chais to make your day.
      </p>
